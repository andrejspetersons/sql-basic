...
import { selectColumnFromTable, selectReviewByAppIdAuthor, selectRowById } from "../src/queries/select";
...
describe("Update Statements", () => {
    ...
    it("should update review developer reply and developer reply date by app id and author", async done => {
        ...
        const appId=24;
        const author="PLAYBOY";
        const devReply="test reply";
        const query = 
        `UPDATE reviews
        SET developer_reply='${devReply}',developer_reply_date='${timeStamp}'
